...
HD_PWD='E:/Verilog Course/Lab session/AND gate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_and.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_and.tcl -notrace
