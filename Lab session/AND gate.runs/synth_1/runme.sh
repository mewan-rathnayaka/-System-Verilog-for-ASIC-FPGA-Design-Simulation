...
HD_PWD='E:/Verilog Course/Lab session/AND gate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_and.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_and.tcl
